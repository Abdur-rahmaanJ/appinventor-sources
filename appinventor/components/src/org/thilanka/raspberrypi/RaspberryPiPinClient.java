...
public class RaspberryPiPinClient extends AndroidNonvisibleComponent implements Component, RaspberryPiMessageListener {
  ...
  private static final int RASPBERRYPI_PINCLIENT_NUMBER_VALUE = 1;
  private static final boolean RASPBERRYPI_PINCLIENT_STATE_VALUE = false;
  private static final int RASPBERRYPI_PINCLIENT_MODE_VALUE = 0;
  private static final int RASPBERRYPI_PINCLIENT_PULLRESISTANCE_VALUE = 1;
  ...
  @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_NON_NEGATIVE_INTEGER,
      defaultValue = RASPBERRYPI_PINCLIENT_NUMBER_VALUE + "")
  ...
  @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_BOOLEAN,
      defaultValue = RASPBERRYPI_PINCLIENT_STATE_VALUE + "")
  ...
  @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_INTEGER,
      defaultValue = RASPBERRYPI_PINCLIENT_MODE_VALUE + "")
  ...
  @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_NON_NEGATIVE_INTEGER,
      defaultValue = RASPBERRYPI_PINCLIENT_PULLRESISTANCE_VALUE + "")
